...
Then you can interact with hubot-pr-status by typing `hubot-pr-status help`.

    hubot-pr-status> hubot-pr-status help
    hubot-pr-status animate me <query> - The same thing as `image me`, except adds [snip]
    hubot-pr-status help - Displays all of the help commands that hubot-pr-status knows about.
    ...
